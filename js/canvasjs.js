...
(function() {
    ...
    function Na(a) {
        if (!Ga) {
            var c = !1,
                b = !1;
            "undefined" === typeof da.Chart.creditHref ? (a.creditHref = "http://canvasjs.com/", a.creditText = "") : (c = a.updateOption("creditText"),
    ...
    var H = {},
        ...
        ca = {
            colorSet1: "#07a8c2 #74ccda #ade1e9".split(" "),
                ...
                if (f = "", f = this.getToolTipInnerHTML({
                    ...
                    try {
                        this.contentDiv.style.background =
                            this.backgroundColor ? this.backgroundColor : t ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.borderColor ? this.borderColor : e[0].dataPoint.color ? e[0].dataPoint.color : e[0].dataSeries.color ? e[0].dataSeries.color : e[0].dataSeries._colorSet[e[0].index % e[0].dataSeries._colorSet.length], this.contentDiv.style.borderWidth = this.borderThickness || 0 === this.borderThickness ? this.borderThickness + "px" : "1px",
